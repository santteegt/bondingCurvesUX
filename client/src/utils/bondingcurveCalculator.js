...
export const calculateSaleReturn = ({ totalSupply, poolBalance, reserveRatio, amount }) => {
    ...
    if (totalSupply.toNumber() === 0 || reserveRatio.toNumber() === 0 || poolBalance.toNumber() === 0 || amount.toNumber() === 0) return '0';
    if (amount.isEqualTo(totalSupply)) return poolBalance;
    if (reserveRatio.toNumber() === 1) return poolBalance;
